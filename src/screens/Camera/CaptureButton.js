...
import {CAPTURE_BUTTON_SIZE, SCREEN_HEIGHT, SCREEN_WIDTH} from '@src/Constants';
...
const _CaptureButton = ({
  ...
  return (
    <TapGestureHandler
      ...
      // <-- this prevents the TapGestureHandler from going to State.FAILED when the user moves his finger outside of the child view (to zoom)
